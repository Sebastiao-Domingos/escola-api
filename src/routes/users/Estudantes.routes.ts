...
estudantes_routes.get(`${BASE_PATH}/turma/:id` ,controller.getEstudantesTurma)
estudantes_routes.get(`${BASE_PATH}/notas/:id` ,controller.getNotasEstudante)
estudantes_routes.get(`${BASE_PATH}/disciplinas/:id` ,controller.getDisciplinasEstudante)
